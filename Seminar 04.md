...
```
##    12    13    14    15     9    10    11    28    29    30    31    24 
## 8.351 8.029 7.904 7.740 7.516 8.070 8.031 7.655 7.552 7.997 7.752 7.653 
##    25    26    27    36    37    38    39    32    33    34    35    20 
## 7.593 7.533 7.799 7.391 8.268 7.498 7.438 7.528 7.714 7.535 7.582 8.476 
##    21    22    23    16    17    18    19     5     6     7     8     1 
## 8.057 7.953 7.268 8.175 8.253 8.314 8.146 8.273 7.994 7.901 8.174 7.954 
##     2     3     4 
## 7.881 7.975 7.808
```
...
```r
ggplot(miniDat, aes(x = gExp, y = gType, color = gType)) + facet_wrap(~gene, 
    scales = "free_x") + geom_point(alpha = 0.7) + theme(panel.grid.major.x = element_blank())
```
